...
\textbf{Batched Matrix-Vector product:}
contract one mode of $\mathcal{X}$ with a vector $\M{u}$, producing a vector. Repeat for each vector in a matrix.
...
% ============================================================
\begin{frame}{Extras: OpenMP attempt}
\begin{itemize}
