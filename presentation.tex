...
\begin{center}
\resizebox{0.95\linewidth}{!}{\input{fig/fig1}}
\end{center}

\begin{itemize}
  \item OMP-32: up to $27\times$ for cache-friendly cases, but only $\sim3\times$ for unfriendly
  \item GPU: the opposite --- greatest speedup on the cache-unfriendly cases
\end{itemize}
